...
const principles = [
  {
    ...
    description: 'I invest time understanding the problem and designing the solution before writing the first line. The cheapest code to maintain is code that was never written.'
  },
  {
    icon: GitBranch,
    title: 'Decisions with explicit trade-offs',
    description: 'Every architectural decision documents alternatives considered and reasons for rejection. Facilitates future reviews and onboarding.'
  },
  {
    icon: Shield,
    title: 'Maintainability over cleverness',
    description: 'I prioritize code that any team developer can understand and modify. Accidental complexity is hidden technical debt.'
  },
  {
    icon: BookOpen,
    title: 'Documentation as product',
    description: 'ADRs, architecture diagrams and contribution guides are part of the deliverable. A system without documentation is a system with an expiration date.'
  },
  {
    icon: FileCode,
    title: 'DX as a multiplier',
    description: 'I invest in tooling, linting and automation. A team with good DX delivers faster with less friction.'
  },
  {
    icon: Users,
    title: 'Collaboration with product & design',
    description: 'I actively participate in product definition. Understanding the "why" allows proposing technical solutions that enable better user experience.'
  }
];
      ...
      <div ref={ref} className="container mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-14">
          ...
          <p className={`mt-4 text-muted-foreground max-w-2xl mx-auto ${isVisible ? 'animate-fade-up stagger-2' : 'opacity-0'}`}>
            Principles that guide my work and define how I approach complex problems.
          </p>
        </div>
